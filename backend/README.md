...
## Project Structure
    ...
    ├── testapiautoconnecto_54714  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_54714`
...
2. Clone this repo and `cd testapiautoconnecto_54714`
